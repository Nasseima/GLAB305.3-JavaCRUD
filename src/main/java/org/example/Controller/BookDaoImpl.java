...
import org.example.Daointerface.ConnectionDOA;
import org.example.model.Books;

public class BookDaoImpl extends ConnectionDOA implements BookDao {
    public void saveBook(List<Books> BookList) {
        try {
            Connection con = ConnectionDOA.getConnection();
    ...
    public List<Books> getAllBooks () {
        try{
            Connection connection = ConnectionDOA.getConnection();
